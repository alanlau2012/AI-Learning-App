...
| P5 | 搜索 / 术语 / 我的学习 | 主开发 | todo | P3,P4 | 搜索可用、术语可浏览、进度准确、清空可用 | — |
| P6 | 响应式、视觉统一、内容补齐、构建检查、README、部署 | 主开发 | todo | P5 | 桌面/移动端稳定、构建成功、可静态部署 | — |
| 内容 | 12 讲（1.0）完整内容生产，先 3–5 讲（Demo） | 内容 Agent → 审核 Agent → 主开发合入 | todo | P1.5,P2 | 走完 §3 流水线 + `validate:structure`/`validate:published-content` 通过 | 等 P1.5 门禁 |
